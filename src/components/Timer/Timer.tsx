...
const Timer: React.FC<TimerProps> = () => {
  ...
  return <div>{showTimer ?
    (
      <div className='flex items-center space-x-2  bg-dark-layer-1 hover:bg-dark-gray-6 p-1.5 rounded cursor-pointer'>
        <div>
          {formatTime(time)}
        </div>
      ...
      <div className='flex items-center p-1 h-8 bg-dark-layer-1 hover:bg-dark-gray-6 py-1.5 rounded cursor-pointer '
