...
const ResetPassword: React.FC<ResetPasswordProps> = () => {
  ...
  useEffect(() => {
    if (error) {
      toast.error("Password Reset Email Sent", { position: "top-center", autoClose: 3000, theme: "dark" })
    }
  }, [error])
  ...
  return (
    <main className="bg-gradient-to-b from-purple-500 to-blue-500 min-h-screen">
      <form className='space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8' onSubmit={handleReset}>
        <h3 className='text-5xl font-medium  text-white'>Reset Password</h3>
        ...
        <button
          type='submit' style={{ backgroundColor: "rgb(255, 161, 22)", color: "white" }}
